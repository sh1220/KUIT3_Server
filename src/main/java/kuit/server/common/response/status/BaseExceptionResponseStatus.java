...
public enum BaseExceptionResponseStatus implements ResponseStatus {
     ...
     *  6000: Restaurant 오류
     */
    INVALID_RESTAURANT_VALUE(6000, HttpStatus.BAD_REQUEST.value(), "가게 등록 요청에서 잘못된 값이 존재합니다."),
    DUPLICATE_STORENAME(6001, HttpStatus.BAD_REQUEST.value(), "이미 존재하는 상호명입니다.");
